  ...
  const equipales: Equipal[] = [
    {
      ...
      reviews: 24,
      description:
        "Silla equipal tradicional con estructura de madera y piel curtida artesanalmente.",
      features: ["Piel natural", "Madera palo dulce", "Resistente al clima"],
      badge: "Más vendido",
    ...
    },
    {
      ...
      rating: 4.7,
      reviews: 12,
      description: "Juego completo de sala con 3 sillones y mesa.",
      features: ["4 piezas", "Colores combinables", "Garantía 2 años"],
      badge: "Oferta",
    ...
    },
    {
      ...
      rating: 4.5,
      reviews: 8,
      description: "Mesa con base de equipal, perfecta para exteriores.",
    ...
    {
      id: 6,
      name: "Comedor + Juego de equipales",
      price: 20000,
      originalPrice: null,
      image: "/comedor.jpeg",
      ...
      reviews: 6,
      description:
        "Comedor hecho a medida según tus especificaciones y gustos.",
    ...
    },
    {
      ...
      reviews: 24,
      description:
        "Cantinero tradicional con estructura de madera y piel curtida artesanalmente.",
      features: ["Piel natural", "Madera de palo rosa", "Resistente al clima"],
      badge: "Más vendido",
      badgeColor: "bg-orange-600",
    },
    {
      ...
      rating: 4.9,
      reviews: 18,
      description: "Silla equipal tradicional con diferentes colores",
      features: ["Piel premium", "Cojines incluidos", "Color"],
      badge: "Premium",
      badgeColor: "bg-amber-600",
    },
    {
      ...
      rating: 4.7,
      reviews: 12,
      description: "Banco con base de madera y piel premium",
      features: ["piel premium", "Colores", "Garantía 2 años"],
      badge: "Oferta",
      badgeColor: "bg-red-600",
    },
    {
      id: 10,
      name: "Comeder Personalizado",
      price: 22000,
      originalPrice: null,
      image: "/galeria4.jpeg",
      category: "juegos",
    ...
    },
    {
      ...
      reviews: 8,
      description:
        "Mesa con base de equipal, perfecta para exteriores e interiores.",
      features: ["Base equipal", "Tapa de madera", "Resistente al agua"],
      badge: null,
      badgeColor: "",
    },
    {
      ...
      rating: 5.0,
      reviews: 6,
      description: "Sala hecha a medida según tus especificaciones y gustos.",
      features: ["Diseño único", "Colores a elección", "Grabado personalizado"],
      badge: "Exclusivo",
      badgeColor: "bg-purple-600",
    },
